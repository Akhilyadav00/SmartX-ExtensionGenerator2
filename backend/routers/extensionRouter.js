...
router.post("/generate", (req, res) => {
  const {filename, imagesData, manifestData, scriptData, htmlData, features} = req.body;
  console.log(features);
  createCode(filename, imagesData, manifestData, scriptData, htmlData, features, (zipfile) => {
    res.json({
